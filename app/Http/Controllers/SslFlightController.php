...
class SslFlightController extends Controller
{
    ...
    public function indexFlight(Request $request ,$id)
    {
       ...
       if ($fli->ticket > 0) {
        ...
        $post_data = array();
        $post_data['total_amount'] = $flight->price; # You cant not pay less than 10
        ...
        $update_product = DB::table('flight_books')
    ...
    public function successful(Request $request)
    {
        ...
        $order_details = DB::table('flight_books')
